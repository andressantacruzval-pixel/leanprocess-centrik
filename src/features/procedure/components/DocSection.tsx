...
export function DocSection({
  ...
  return (
    <div className="group/section">
      <div className="flex items-center gap-2 mb-3 border-b-2 border-blue-600 pb-1.5">
        ...
        {onImprove && (
          <button
            ...
            className="opacity-0 group-hover/section:opacity-100 pointer-coarse:opacity-100 p-2 rounded text-gray-500 hover:text-blue-600 hover:bg-blue-50 disabled:opacity-30 transition-all"
          >
