import { FileText, Book, BarChart3, ShieldAlert, ClipboardCheck, Activity, Lightbulb } from 'lucide-react'
...
export type RightPanelTab = 'info' | 'procedimiento' | 'indicadores' | 'riesgos' | 'auditoria' | 'analisis' | 'mejoras' | null
