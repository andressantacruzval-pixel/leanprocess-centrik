import { FileText, Book, BarChart3, ShieldAlert, ClipboardCheck, Activity } from 'lucide-react'
...
export type RightPanelTab = 'info' | 'procedimiento' | 'indicadores' | 'riesgos' | 'auditoria' | 'analisis' | null
